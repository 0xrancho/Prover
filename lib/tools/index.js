...
export const TOOLS = {
  ...
  web_search: {
    name: 'web_search',
    description: 'Search the web for real-time information about companies. Use for finding company websites, industry info, news, or enrichment data.',
    parameters: {
      type: 'object',
      properties: {
        query: {
          type: 'string',
          description: 'Search query - include company name and what info you need (e.g., "Acme Corp website industry")'
        },
        url: {
          type: 'string',
